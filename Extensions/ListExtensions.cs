...
public static class ListExtensions {
  public static int BinarySearch<T>(this IReadOnlyList<T> collection, T? item) where T : IComparable<T> {
  ...
  public static int BinarySearch<TItem, TCompare>(this IReadOnlyList<TItem> collection, TCompare? item, Func<TItem, TCompare> selector) 
