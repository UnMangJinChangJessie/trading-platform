...
public class StockInquireBalanceQueries : IAccount, IConsecutive {
  ...
  public required bool IncludeYesterdayTrade { get; set; }
}
...
public class StockInquireBalanceResult : KisReturnMessage, IReturnConsecutive {
  ...
  [JsonPropertyName("output1")] public IEnumerable<StockBalance>? HoldingStocks { get; set; }
  // Is defined as array but pretty sure this is a singleton
  [JsonPropertyName("output2")] public IEnumerable<AccountBalance>? AccountBalance { get; set; }
}

public partial class DomesticStock {
  public static Action<StockInquireBalanceQueries, Action<string>?> InquireStockBalance = (queries, cb) =>
    ApiClient.PushRequest(
      ...
      queries: new Dictionary<string, string>() {
        ...
        ["PRCS_DVSN"] = queries.IncludeYesterdayTrade ? "00" : "01",
